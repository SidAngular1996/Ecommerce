...
exports.registerUser = catchAsyncErrors(async (req, res, next) => {
 ...
 // sendToken is used to set token to cookie
 // which is used in auth.js to check authenticated user
...
exports.loginUser = catchAsyncErrors(async (req, res, next) => {
  ...
  // since select is false in scheme so that it does not get visbile by query to admin
  // .select is used with password to have a selection
...
exports.forgotPassword = catchAsyncErrors(async (req, res, next) => {
  ...
  try {
    ...
    // since the user was saved with token on line 99
    // if ther is error this needs to be undefined
    user.resetPasswordToken = undefined;
    user.resetPasswordExpire = undefined;

    // after undefined needs to be saved
    await user.save({ validateBeforeSave: false });
